...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = AppUtils.getAppContext()
                    .getPackageManager()
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && AppUtils.getAppContext().getExternalCacheDir() != null)
                sDefaultDir = AppUtils.getAppContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = AppUtils.getAppContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
